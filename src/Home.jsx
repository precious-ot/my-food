...
export default function Home(url){
    ...
    return(
        ...
        <button onClick={closeMenuBar}>
            ...
            <div className="my-auto grid mt-10 py-4">
               <div className="place-items-center">
                ...
                <div className="place-items-start mt-20 text-start max-w-2xl mb-10">
                    <p className="text-slate-300 font-semibold text-md">Join us in our cozy dining room and experience the essence of farm-to-table dining in every bite. Welcome to The Luxury resturant - where every meal is a celebration of the harvest</p>
                </div>
            </div>
            </div>
            <div className="text-white text-center bg-slate-950 sticky py-4 bottom-0 w-full left-0">
